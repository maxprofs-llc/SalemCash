...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/SalemCash-core/gitian.sigs.git
    git clone https://github.com/SalemCash-core/SalemCash-detached-sigs.git
...
### Fetch and create inputs: (first time, or when dependency versions change)
    ...
    pushd ./gitian-builder
    mkdir -p inputs
    wget -P inputs https://SalemCashcore.org/cfields/osslsigncode-Backports-to-1.7.1.patch
...
- Detached signatures will then be committed to the [bitcoin-detached-sigs](https://github.com/SalemCash-core/SalemCash-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - SalemCash Core announcements list https://salemcashcore.org/en/list/announcements/join/

  - Salemcashcore.org blog post
