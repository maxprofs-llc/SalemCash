...
#ifndef SALEMCASH_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define SALEMCASH_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // SALEMCASH_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
