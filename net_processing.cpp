    ...
    case MSG_WITNESS_TX:
        {
            ...
            return recentRejects->contains(inv.hash) ||
                   ...
                   pcashTip->HaveCashInCache(COutPoint(inv.hash, 0)) || // Best effort: only try output 0 and 1
                   pcashTip->HaveCashInCache(COutPoint(inv.hash, 1));
        }
    case MSG_BLOCK:
                     ...
                     ++mi)
                {
                    ...
                    else if (!fMissingInputs2)
                    {
                        ...
                        if (!orphanTx.HasWitness() && !stateDummy.CorruptionPossible()) {
                            ...
                            // See https://github.com/PastorOmbura/SalemCash/issues/8279 for details.
                            assert(recentRejects);
    ...
    else if (strCommand == NetMsgType::BLOCKTXN && !fImporting && !fReindex) // Ignore blocks received while importing
    {
        ...
        bool fBlockRead = false;
        {
            ...
            if (status == READ_STATUS_INVALID) {
                ...
                //    impossible here)
                // 3. the block is otherwise invalid (eg invalid cashbase,
