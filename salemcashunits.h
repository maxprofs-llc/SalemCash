...
#ifndef SALEMCASH_QT_SALEMCASHUNITS_H
#define SALEMCASH_QT_SALEMCASHUNITS_H
...
/** Salemcash unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SalemcashUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SalemcashUnits(QObject *parent);

    /** Salemcash units.
      @note Source: https://en.salemcash.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SCS,
...
typedef SalemcashUnits::Unit SalemcashUnit;

#endif // SALEMCASH_QT_SALEMCASHUNITS_H
