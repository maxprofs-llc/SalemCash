...
BOOST_AUTO_TEST_CASE(util_FormatMoney)
{
    ...
    BOOST_CHECK_EQUAL(FormatMoney((CASH/10000)*123456789), "12345.6789");
    BOOST_CHECK_EQUAL(FormatMoney(-CASH), "-1.00");

    BOOST_CHECK_EQUAL(FormatMoney(CASH*100000000), "100000000.00");
    BOOST_CHECK_EQUAL(FormatMoney(CASH*10000000), "10000000.00");
    BOOST_CHECK_EQUAL(FormatMoney(CASH*1000000), "1000000.00");
    BOOST_CHECK_EQUAL(FormatMoney(CASH*100000), "100000.00");
    BOOST_CHECK_EQUAL(FormatMoney(CASH*10000), "10000.00");
    BOOST_CHECK_EQUAL(FormatMoney(CASH*1000), "1000.00");
    BOOST_CHECK_EQUAL(FormatMoney(CASH*100), "100.00");
    BOOST_CHECK_EQUAL(FormatMoney(CASH*10), "10.00");
    BOOST_CHECK_EQUAL(FormatMoney(CASH), "1.00");
    BOOST_CHECK_EQUAL(FormatMoney(CASH/10), "0.10");
    BOOST_CHECK_EQUAL(FormatMoney(CASH/100), "0.01");
    BOOST_CHECK_EQUAL(FormatMoney(CASH/1000), "0.001");
    BOOST_CHECK_EQUAL(FormatMoney(CASH/10000), "0.0001");
    BOOST_CHECK_EQUAL(FormatMoney(CASH/100000), "0.00001");
    BOOST_CHECK_EQUAL(FormatMoney(CASH/1000000), "0.000001");
    BOOST_CHECK_EQUAL(FormatMoney(CASH/10000000), "0.0000001");
    BOOST_CHECK_EQUAL(FormatMoney(CASH/100000000), "0.00000001");
}
...
BOOST_AUTO_TEST_CASE(util_ParseMoney)
{
    ...
    BOOST_CHECK_EQUAL(ret, (CASH/10000)*123456789);

    BOOST_CHECK(ParseMoney("100000000.00", ret));
    BOOST_CHECK_EQUAL(ret, CASH*100000000);
    BOOST_CHECK(ParseMoney("10000000.00", ret));
    BOOST_CHECK_EQUAL(ret, CASH*10000000);
    BOOST_CHECK(ParseMoney("1000000.00", ret));
    BOOST_CHECK_EQUAL(ret, CASH*1000000);
    BOOST_CHECK(ParseMoney("100000.00", ret));
    BOOST_CHECK_EQUAL(ret, CASH*100000);
    BOOST_CHECK(ParseMoney("10000.00", ret));
    BOOST_CHECK_EQUAL(ret, CASH*10000);
    BOOST_CHECK(ParseMoney("1000.00", ret));
    BOOST_CHECK_EQUAL(ret, CASH*1000);
    BOOST_CHECK(ParseMoney("100.00", ret));
    BOOST_CHECK_EQUAL(ret, CASH*100);
    BOOST_CHECK(ParseMoney("10.00", ret));
    BOOST_CHECK_EQUAL(ret, CASH*10);
    BOOST_CHECK(ParseMoney("1.00", ret));
    BOOST_CHECK_EQUAL(ret, CASH);
