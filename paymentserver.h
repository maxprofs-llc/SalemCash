...
#ifndef SALEMCASH_QT_PAYMENTSERVER_H
#define SALEMCASH_QT_PAYMENTSERVER_H
...
// but the main window (and the Send Cash tab) is not.
//
// So, the strategy is:
//
...
Q_SIGNALS:
    ...
    void receivedPaymentRequest(SendCashRecipient);
...
public Q_SLOTS:
    ...
    void fetchPaymentACK(CWallet* wallet, const SendCashRecipient& recipient, QByteArray transaction);
...
private:
    ...
    bool processPaymentRequest(const PaymentRequestPlus& request, SendCashRecipient& recipient);
...
#endif // SALEMCASH_QT_PAYMENTSERVER_H
