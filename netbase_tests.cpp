...
{
    BOOST_CHECK(TestSplitHost("www.salemcash.org", "www.salemcash.org", -1));
    BOOST_CHECK(TestSplitHost("[www.salemcash.org]", "www.salemcash.org", -1));
    BOOST_CHECK(TestSplitHost("www.salemcash.org:80", "www.salemcashorg", 80));
    BOOST_CHECK(TestSplitHost("[www.salemcash.org]:80", "www.salemcash.org", 80));
