...
#ifndef SALEMCASH_TEST_SCRIPTNUM10_H
#define SALEMCASH_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from SalemCash 0.10.0, for cross-comparison.
 */
public:
