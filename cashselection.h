...
#ifndef SALEMCASH_CASHSELECTION_H
#define SALEMCASH_CASHSELECTION_H
...
class CInputCash {
public:
    CInputCash(const CTransactionRef& tx, unsigned int i)
    {
        if (!tx)
    ...
    bool operator<(const CInputCash& rhs) const {
