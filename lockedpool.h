...
#ifndef SALEMCASH_SUPPORT_LOCKEDPOOL_H
#define SALEMCASH_SUPPORT_LOCKEDPOOL_H
...
public:
    ...
    Arena(const Arena& other) = delete; // non construction-copiable
    Arena& operator=(const Arena&) = delete; // non copiable
...
public:
    ...
    LockedPool(const LockedPool& other) = delete; // non construction-copiable
    LockedPool& operator=(const LockedPool&) = delete; // non copiable
...
#endif // SALEMCASH_SUPPORT_LOCKEDPOOL_H
